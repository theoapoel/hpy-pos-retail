...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .pay-head { display: flex; align-items: center; justify-content: space-between; gap: 8px; margin-bottom: 6px; }
        .pay-head-label { font-size: 11px; font-weight: 800; letter-spacing: .5px; color: var(--text3); }
        .split-toggle {
        ...
        .split-panel {
            ...
            padding: 10px; margin-bottom: 10px; background: var(--surface2);
        }
        ...
        .split-amt {
            width: 108px; flex-shrink: 0; padding: 7px 9px; border: 2px solid var(--border);
...
<div class="pos-layout">
    ...
    <div class="pos-cart">
        ...
        <div class="cart-payment">
            <div class="pay-head">
                <span class="pay-head-label" id="payHeadLabel">METODE BAYAR</span>
            ...
            <!-- Panel pembayaran campuran — muncul hanya saat mode campuran aktif -->
...
function toggleSplitMode() {
    ...
    toggle.classList.toggle('on', splitMode);
...
function updateSplitSummary() {
    ...
    document.getElementById('splitBarFill').style.width = pct + '%';
    document.getElementById('splitBarFill').style.background = remain < 0 ? 'var(--red)' : 'var(--green)';
