    ...
    for (let i = 0; i < WAREHOUSES.length; i++) {
        ...
        try {
            ...
            if (res.success) {
                ...
                const detail = `Bin dari ERP: <strong>${res.bin_count}</strong> &nbsp;·&nbsp; Cocok: <strong>${res.matched}</strong> &nbsp;·&nbsp; Qty berubah: <strong>${res.updated}</strong> &nbsp;·&nbsp; Tidak cocok: <strong>${res.skipped}</strong>${removed} &nbsp;·&nbsp; Tersimpan di DB: <strong>${res.db_rows}</strong>`;
