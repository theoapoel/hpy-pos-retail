...
class UpdateController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('update.index', ['local' => $info]);
    }
    ...
    public function checkLatest()
    {
        try {
            ...
            $res    = $client->get(
                ...
                ['headers' => ['User-Agent' => 'HPYSync-POS/1.0', 'Accept' => 'application/vnd.github.v3+json']]
            );
            ...
            return response()->json(['success' => false, 'error' => 'Tidak dapat menghubungi GitHub: ' . $e->getMessage()], 422);
        }
    }
    ...
    public function run(Request $request)
    {
        ...
        // git pull
        $log[] = '▶ git pull origin ' . self::GITHUB_BRANCH;
        exec('git -C ' . escapeshellarg($base) . ' pull origin ' . self::GITHUB_BRANCH . ' 2>&1', $pullOut, $code);
    ...
    private function localVersionInfo(): array
    {
        ...
        // Coba ambil commit date & message dari git log
        $date    = '';
        $message = '';
        $logOut  = [];
