...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    // Hanya file upload (gambar produk, dsb). Kode sumber tidak
                    // perlu di-backup karena sudah ada di git. Set [] untuk DB saja.
    ...
    'notifications' => [
        'notifications' => [
            // Hanya beri notifikasi saat ADA MASALAH, supaya tidak spam tiap hari.
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', 'admin@larapos.com'),
